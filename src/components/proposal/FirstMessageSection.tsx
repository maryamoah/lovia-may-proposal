...
export function FirstMessageSection() {
  return (
    <section data-navigation-theme="light" className="chapter bg-cream px-5 py-14 text-espresso sm:px-8 lg:py-[4.5rem]" aria-labelledby="first-message-title">
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2 lg:items-center xl:gap-24">
        <motion.div variants={textReveal} initial="hidden" whileInView="visible" viewport={viewportOnce}>
          ...
          <p className="mt-8 max-w-xl text-sm leading-7 text-espresso/55">A small screen, a simple message, and the first conversation I still smile about.</p>
        </motion.div>
        <motion.div variants={imageReveal} initial="hidden" whileInView="visible" viewport={viewportOnce} className="relative mx-auto w-full max-w-[420px]">
