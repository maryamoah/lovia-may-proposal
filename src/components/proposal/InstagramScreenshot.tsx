    ...
    <div className="grid aspect-[9/16] w-full place-items-center rounded-[1.35rem] bg-[#efe3cf] px-6 text-center text-espresso">
      <div>
        <p className="font-serif text-2xl leading-tight">
          Our first Instagram conversation
        </p>
        <p className="mt-4 text-[.64rem] uppercase leading-5 tracking-[.22em] text-gold">
          {story.beginning.placeholder}
        </p>
      </div>
    </div>
  );
      ...
      <div className="mx-auto w-full">
        ...
        >
          <span className="sr-only">
            Open the first Instagram message screenshot
          </span>
          <OptionalImage
            src={src}
            alt="First Instagram conversation"
            className="aspect-[9/16] rounded-[1.25rem]"
            imageClassName="object-contain bg-[#efe3cf]"
            fallback={<Placeholder />}
          />
        </button>
        <div className="mt-4 grid gap-2 text-center sm:grid-cols-2 sm:text-left">
          <p className="rounded-full bg-ivory/80 px-4 py-2 font-serif text-sm italic leading-5 text-rose shadow-sm sm:text-base">
            {story.beginning.annotation}
          </p>
          <p className="self-start rounded-full bg-ivory/80 px-4 py-2 text-[.58rem] uppercase tracking-[.18em] text-gold shadow">
            {story.beginning.floatingDate}
          </p>
        </div>
      </div>
        ...
        {expanded ? (
          ...
          >
            <h2 id="instagram-lightbox-title" className="sr-only">
              First Instagram message screenshot
            </h2>
            <button
              ref={closeButtonRef}
              type="button"
