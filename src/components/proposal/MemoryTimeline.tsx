    ...
    <div className="mt-8 space-y-5">
      {memory.caption.split(". ").map((line, index) => (
        <motion.p
          ...
          className={`story-copy text-base leading-7 sm:text-xl sm:leading-8 ${light ? "text-espresso/70" : "text-ivory/72"}`}
        >
          {line.replace(/\.$/, "")}.
        </motion.p>
      ))}
...
export function MemoryTimeline() {
  ...
  return (
    <section id="memories" className="text-espresso">
        ...
        <div className="section-space mx-auto grid w-full max-w-7xl gap-8 safe-px md:grid-cols-[1.05fr_.95fr] md:items-center lg:gap-10">
          ...
          >
            <Image
              ...
              alt="May and Lovia feeling at home together"
              fill
          ...
          <div className="relative">
            <div className="max-w-xl">
              ...
              <h2 className="mt-5 font-serif text-[clamp(2.4rem,7vw,5.8rem)] leading-[.95] tracking-[-.035em]">
                {firstMeeting.title}
              </h2>
      ...
      <section className="section-space relative overflow-hidden bg-ivory safe-px text-espresso">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[.92fr_1.08fr] md:items-center lg:gap-10">
          <motion.div
            ...
            whileInView="visible"
            viewport={viewportOnce}
            className="overflow-hidden rounded-sm border border-gold/25 bg-cream shadow-[0_24px_70px_rgba(27,18,14,.08)]"
          >
            <div className="relative aspect-[4/3] w-full">
              <Image
                src={story.media.walkSideBySide}
                alt="May and Lovia sharing a quiet moment together"
                fill
                sizes="(max-width: 1024px) 100vw, 50vw"
                className="object-contain"
              />
        ...
        <div className="section-space mx-auto w-full max-w-7xl safe-px">
          <div className="grid items-center gap-8 md:grid-cols-[0.9fr_1.1fr] lg:gap-16">
            ...
            >
              ...
              <h2 className="mt-4 font-serif text-[clamp(2.2rem,5.4vw,4.8rem)] leading-[1.02] tracking-[-.035em]">
                Côte d’Ivoire, zero French, and one mission.
              </h2>
              <p className="eyebrow mt-7 text-gold">{attieke.eyebrow}</p>
              <h3 className="mt-3 font-serif text-[clamp(1.9rem,4vw,3.35rem)] leading-tight">
                {attieke.title}
              </h3>
              <p className="story-copy mt-5 max-w-2xl text-base leading-7 sm:text-lg sm:leading-8 text-espresso/68">
                {attieke.caption}
              </p>
            </motion.div>
            ...
            >
              <div className="overflow-hidden rounded-sm border border-gold/30 bg-cream shadow-[0_22px_60px_rgba(27,18,14,.08)]">
                <OptionalImage
                  src={story.media.attiekeFunnyMoment}
                  alt={attieke.title}
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2 md:items-center lg:gap-10">
          ...
          >
            <div className="relative aspect-[4/3] w-full">
              <Image
                src={story.media.holdingHands}
                alt="May and Lovia holding hands through life"
                fill
                sizes="(max-width: 1024px) 100vw, 50vw"
                className="object-contain"
              />
      ...
      <section
        data-navigation-theme="dark"
        className="relative overflow-hidden bg-cream safe-px py-16 text-center sm:px-10 lg:py-28"
      >
        <motion.div
          variants={imageReveal}
          initial="hidden"
        ...
        <div className="relative mx-auto max-w-4xl py-10 text-ivory">
          ...
          <h2 className="mt-5 font-serif text-[clamp(2.5rem,8vw,6.4rem)] leading-[.96] tracking-[-.035em]">
            {capeCoast.title}
          </h2>
          <div className="mx-auto mt-8 max-w-2xl space-y-4">
            {capeCoast.caption.split(". ").map((line, index) => (
              <motion.p
                ...
                viewport={viewportText}
                transition={{ ...textTransition, delay: index * 0.08 }}
                className="story-copy text-base leading-7 sm:text-lg sm:leading-8 text-ivory/82 sm:text-xl"
              >
                {line.replace(/\.$/, "")}.
              </motion.p>
            ))}
