      ...
      <AnimatePresence mode="wait">
        {!unlocked ? (
          ...
          >
            ...
            <h1 className="mt-4 font-serif text-balance text-[clamp(2.35rem,10vw,4.5rem)] leading-[.95] tracking-[-.035em]">
            ...
            <input
              ...
              autoComplete="off"
              inputMode="text"
              className="mt-4 w-full rounded-none border-b border-gold/35 bg-transparent px-3 py-4 text-center text-lg tracking-[.24em] text-ivory outline-none transition placeholder:text-ivory/25 focus:border-gold"
              aria-invalid={error}
            />
            <p className="mt-3 min-h-6 text-sm text-blush" aria-live="polite">
              {error
                ? "Not quite, Mommie. Think of the day we finally met."
                : ""}
            </p>
          ...
          >
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="mb-8 font-serif text-3xl italic text-ivory/82"
            >
              You remembered.
            </motion.p>
            <button
              onClick={onOpen}
              aria-label="Press the wax seal to begin our story"
              className="wax-seal mx-auto grid h-24 w-24 sm:h-28 sm:w-28 place-items-center rounded-full bg-rose font-serif text-4xl sm:text-5xl text-ivory transition hover:scale-[1.03]"
            >
              M
            </button>
            <p className="mt-8 font-serif text-2xl text-ivory/86">
              Everything after this belongs to us.
            </p>
            <p className="mt-3 text-sm uppercase tracking-[.24em] text-gold/80">
              Press the seal
            </p>
          </motion.div>
        )}
